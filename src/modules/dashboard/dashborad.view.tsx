...
import { Download, Factory, FilterX, Repeat2, Table, Target, Trash2 } from "lucide-react"
...
export function DashboardView({ controller }: props) {
  return (
    <div className="max-w-[1200px] mx-auto p-4 bg-white shadow-lg rounded-md h-full flex flex-col gap-2 overflow-auto" >
      ...
      <div className="w-full min-h-12 flex justify-between items-center flex-wrap">
